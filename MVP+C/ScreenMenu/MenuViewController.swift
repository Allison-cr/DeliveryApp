...
final class MenuViewController: UIViewController {
    ...
    private lazy var imageViewHeader: UIImageView = settingImageViewHeader()
...
private extension MenuViewController {
    ...
    // MARK: SettingImageViewHeader
    func settingImageViewHeader() -> UIImageView {
...
private extension MenuViewController {
    ...
    func reloadData() {
        ...
        /// add elements in relevant section
    ...
    func settingDataSource() {
        dataSource = СollectionDataSource(
            ...
            ///provides the creation and configuration of cells depending on the section.
            cellProvider: {
                collectionView,
                indexPath,
                itemIdentifier in
    ...
    func settingSupplementaryView() {
        ...
        // supplementary view use for each section
